...
BEGIN
    SELECT course_id, C.name AS course_name, credits, quota, slot, C.classroom_id, (CONCAT(U.name," ",surname)) AS instructor_full_name, campus, department_id AS department_id
	 FROM Course C 
